            ...
            if (MED.filters.custom && typeof MED.filters.custom == "function") {
                ...
                if (MED.filters.include) {
                    ...
                    for (e = 0; e < ea.length; e++) {
                        ...
                        if (ev.title.match(ei) || ev.description.match(ei)) {
                            ret = true;
                        }
                    }
        ...
        freshTimelines: function () {
            ...
            for (var a = 0; a < active.length; a++) {
                ...
                if (MED.viewMode == "timeline") {
                    ...
                    if (tl_bottom < tl_min_bottom)
                        tl_bottom = tl_min_bottom;
                    ...
                    if (expCol == "expanded") {
                        tl.borg = borg = new timeglider.TG_Org();
                    }
                    ...
                    if (stuff != "undefined") {
                        $(".tg-list-events ul").append(stuff.html);
                    }
                    ...
                    $(".tg-list-li").bind("click", function () {
                        if (tg.listIScroll.distance > 20 || tg.listIScroll.moved)
                            return false;
                        var $ev = $(this);
                        var evid = $ev.attr("id");
                ...
                if (this.passesFilters(ev, zl) === true) {
                    ...
                    if (expCol == "expanded") {
                        ...
                        if (ev.span == true) {
                            ...
                            if (ev.spanwidth > ev.width) {
                                ev.width = ev.spanwidth + buffer;
                            }
                        }
