...
class M_customers extends CI_Model {
    ...
    function getCustomerDetail() {
        $this->db->select('U.user_id,profile_pic,name,email,phone,phone_verification,P.plan_name,amount,PD.plan_id,PD.register_date,status,plan_status,cancel_by,is_lifetime');
