                ...
                <div class="modal-body">
                    ...
                    <div id="n_check_block" class="row">
                        <div class="col-md-12">
                            ...
                            <span class="lbl padding-8">Set Repeat</span>
                        </div>
                    </div>
                    <br/>
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <label>Repeat Every <span id="n_txt_freq_type">Days</span></label>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group" >
                                                ...
                                                <div id="n_end_block" style="display: none" >
                                                    <div style="float: left;padding-right: 5px;cursor: pointer;">
                                                        <input value="" type="text" name="occurance" class="form-control"   /> 
                                                    </div>
                                                    <div  style="float: left;padding:7px 5px;cursor: pointer">
                                                        Occurances
                                                    </div>
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <label>Repeat Every <span id="e_txt_freq_type">Days</span></label>
                                            <div class="form-group">
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <label>Repeat Every <span id="txt_freq_type"></span></label>
                                            <div class="form-group">
...
<script type="text/javascript">
    ...
    $('#eventForm input[name="assign"]').change(function () {
        ...
        if ($(this).val() == "all_c") {
            $.ajax({
                type: 'POST',
                url: "<?= site_url() ?>app/calender/allContacts/" + type,
    ...
    $('#calendar').fullCalendar({
        ...
        eventRender: function (event, element, view) {
            /*var _output = "<dl class='dl-horizontal'>";
             ...
             $.ajax({
             type: 'POST',
             url: '<?= site_url() ?>app/calender/getEvent/' + event.id,
             success: function (json, textStatus, jqXHR) {
             var data = JSON.parse(json);
