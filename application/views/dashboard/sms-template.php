...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <a href="<?= site_url() ?>app/sms_template/addTemplate" class="btn btn-success btn-sm">
                                ...
                                <tbody>
                                    <?php foreach ($template as $value) { ?>
                                        <tr>
                                            ...
                                            <td><?= $value->title ?></td>
                                            <td>
                                                <a href="<?= site_url() ?>app/sms_template/editTemplate/<?= $value->template_id ?>" class="btn bg-navy btn-xs">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function action(actiontype) {
            ...
            $('#checkForm').attr('action', "<?= site_url() ?>app/sms_template/action");
            $('#checkForm').submit();
        }
    });
