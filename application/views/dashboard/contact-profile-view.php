...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <a style="margin-left: 10px" href="<?= site_url() ?>app/contacts/editContact/<?= $contact->contact_id ?>" class="btn bg-navy">
    ...
    <section class="content">
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_1">
                                    <form id="smsForm" role="form" action="<?= site_url() ?>app/contacts/send_message" method="post" >
                                        <div class="row">
        
                                            <div class="col-md-3">
                                                <div class="pull-left" style="padding: 10px"><label>From</label></div>
                                                <div class="pull-left" style="padding: 10px"><span class="title">+17606422366</span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
        ...
        <?php } ?>
                                ...
                                <div class="tab-pane" id="tab_2">
                                    <form id="emailForm" role="form" action="<?= site_url() ?>app/contacts/send_email" method="post" >
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="pull-left" style="padding: 10px"><label>From</label></div>
    ...
    $(document).ready(function () {
        ...
        $('select[name="sms_template_id"]').change(function () {
            ...
            if (tempid == "-1") {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?= site_url() ?>app/sms/getTemplate/" + tempid,
        ...
        $('select[name="email_template_id"]').change(function () {
            ...
            if (tempid == "-1") {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?= site_url() ?>app/email/getTemplate/" + tempid,
                    success: function (json, textStatus, jqXHR) {
                        var data = JSON.parse(json);
//                        $('#body').val(data.body);
