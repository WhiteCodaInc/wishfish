<html>
    <head>
        ...
        <!-- HopScotch CSS -->
        <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/hopscotch/hopscotch.css"/>
        ...
        <script type="text/javascript" src="<?= base_url() ?>assets/hopscotch/hopscotch.js"></script>
...
//                        $('.event').css({position: 'fixed', top: '0px'});
...
//                        $('.event').css({position: 'static', top: '0px'});
