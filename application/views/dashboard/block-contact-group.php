...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1 style="margin-left: 10%;float: left">
            Contact Block List
        </h1>
        <button id="submitBlock" class="btn btn-primary">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <form id="blockForm" role="form" action="<?= site_url() . "app/contacts/" . $method ?>" method="post">
                        <div class="box-body">
