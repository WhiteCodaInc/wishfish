...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1 style="margin-left: 13%;float: left">Contact Detail</h1>
        <button type="button" id="updateContact" class="btn btn-primary">Save Contact Detail</button>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form id="contactForm" role="form" action="<?= site_url() ?>app/contacts/updateContact" enctype="multipart/form-data" method="post">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-7">
                                        <label>Contact Groups</label><a style="margin-left: 10px" href="<?= site_url() . 'contact_groups/addContactGroup' ?>" >Create New Contact Group</a>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="birthday" value="<?= isset($contacts) ? $this->wi_common->getUTCDate($contacts->birthday) : '' ?>"  class="form-control form-control-inline input-medium default-date-picker" size="16" type="text">
                                </div><!-- /.input group -->
                            </div><!-- /.form group -->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input value="<?= isset($contacts) ? $contacts->birthday_alert : '' ?>" name="birthday_alert"  type="text" class="form-control" placeholder="" disabled="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input value="<?= isset($contacts) ? $contacts->contact : '' ?>" name="contact" type="text" class="form-control" placeholder="" disabled="">
                            </div>
                            <div class="form-group">
