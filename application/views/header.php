...
<html>
    <head>
        ...
        <meta property="og:image" content="<?= base_url() ?>assets/wow/300x300.png" />
        ...
        <link rel="stylesheet" href="<?= base_url() ?>assets/wow/css/nivo-lightbox.css">
        <link rel="stylesheet" href="<?= base_url() ?>assets/wow/css/themes/default/default.css">
        <link rel="stylesheet" href="<?= base_url() ?>assets/wow/css/owl.carousel.css" />
        <link rel="stylesheet" href="<?= base_url() ?>assets/wow/css/animate.min.css">
