...
<aside class="right-side">
    ...
    <?php
    $img_src = ($customer->customer_avatar != "") ?
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-3">
                        <div class="user-panel">
                            ...
                            <div class="info" style="text-align: center">
                                <h3 class="title" style="margin: 0"><?= $customer->fname . ' ' . $customer->lname ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4" style="margin-top:10px ">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <span class="title"><?= $customer->zodiac ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <span class="title"><?= ($customer->rating != "-1") ? $customer->rating : 'N/A' ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12"><h4 style="margin-top: 5px">Customer Groups</h4></div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <span class="title"><?= date('m-d-Y', strtotime($customer->register_date)) ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4"><label>Join Url</label></div>
                                <div class="col-md-8">
                                    <span class="title"><?= ($customer->joined_url != NULL) ? $customer->joined_url : 'N/A' ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
